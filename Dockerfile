...
LABEL      Description="Synchronize user data from LDAP to Itop" Version="0.4.1"
...
ADD ./root/scripts/itop-docker/*.{php,sh}       /root/scripts/itop-docker/
...
#ADD ./root/scripts/itop-docker/config/*  /root/scripts/itop-docker/config/
